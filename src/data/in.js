const languageIn = {
  ...
  LEGAL: 'कानूनी',
  BACKUP_RESTORE: 'बैकअप बहाल',
  PUSH_SERVICE: 'धक्का सेवा',
  MAILER: 'मेलर',
  PERMISSIONS: 'अनुमति',
  APPEARANCE: 'रूप',
  SETTINGS: 'समायोजन',
  ...
  REPORTS: 'रिपोर्ट',
  DEPARTMENTS: 'लॉग',
  CUSTOMER_GROUPS: 'कस्टमर ग्रूप्स',
  ADMINS: 'व्यवस्थापक',
  AGENTS: 'एजेंट',
  MESSAGES: 'संदेश',
  PENDING: 'लंबित',
  ...
  BREAKDOWN: 'टूट - फूट',
  TOP5GROUPS: 'शीर्ष 5 समूह',
  TOP10TAGS: 'शीर्ष 10 नाम',
  OVERDUE: 'अतिदेय',
  WELCOME: 'स्वागत',
  TICKETS: 'टिकट',
  ARTICLES: 'लेख',
  ...
  LEVEL_2_DESCRIPTION:
    'हर स्तर 1 करता है, बनाने या लेख को संपादित कर सकते हैं कर सकते हैं और यह कस्टम प्रतिक्रियाओं बना सकते हैं।',
  LEVEL_3_DESCRIPTION:
    'हर स्तर 2 करता है क्या कर सकते हैं, बना सकते हैं या संपादित स्टाफ के सदस्यों और पूरी प्रणाली का प्रबंधन कर सकते हैं।',
  ...
  ADMIN_PASSWORD_DESCRIPTION:
    'कृपया इस पासवर्ड को याद रखें यह व्यवस्थापक पैनल तक पहुंचने के लिए आवश्यक है। आप इसे बाद में बदल सकते हैं।',
  INSTALLATION_COMPLETED: 'स्थापन पूर्ण हुआ।',
  INSTALLATION_COMPLETED_DESCRIPTION:
    'OpenSupports की स्थापना पूरी हो गई है। व्यवस्थापक पैनल पर पुनर्निर्देशित किया जा रहा है ...',

  STEP_TITLE: 'चरण {current} का {total} - {title}',
  STEP_1_DESCRIPTION: 'स्थापना विज़ार्ड के लिए अपनी पसंदीदा भाषा चुनें।',
  STEP_2_DESCRIPTION:
    'यहां OpenSupports चलाने के लिए आवश्यकताओं को सूचीबद्ध किया गया है। कृपया सुनिश्चित करें कि सभी आवश्यकताओं को संतुष्ट किया गया है।',
  ...
  CREATE_TICKET_DESCRIPTION:
    'यह टिकट बनाने के लिए एक रूप है। फार्म भरें और हमें अपने मुद्दों / संदेह / सुझाव भेज सकते हैं। हमारे समर्थन प्रणाली के रूप में जल्द से जल्द यह जवाब देना होगा।',
  TICKET_LIST_DESCRIPTION: 'यहाँ आप सभी टिकट आप हमारी टीम का समर्थन करने के लिए भेजा है की एक सूची पा सकते हैं।',
  TICKETS_DESCRIPTION:
    'हमारे समर्थन केंद्र के माध्यम से टिकट भेजने और अपनी चिंताओं, सुझाव और मुद्दों का जवाब मिलता है।',
  ARTICLES_DESCRIPTION: 'आम मुद्दों, गाइड और प्रलेखन के बारे में हमारे लेख के लिए एक नज़र रखना।',
  ACCOUNT_DESCRIPTION:
    'अपने सभी टिकट अपने खाते के प्रोफाइल में जमा हो जाती है। अपने सभी टिकट आप हमारे स्टाफ की टीम को भेजने का ट्रैक रखें।',
  SUPPORT_CENTER_DESCRIPTION:
    'हमारे समर्थन केंद्र में आपका स्वागत है। आप एक टिकट प्रणाली के माध्यम से संपर्क कर सकते हैं। आपका टिकट हमारे कर्मचारियों द्वारा जवाब दिया जाएगा।',
  ...
  BAN_USERS_DESCRIPTION:
    'यहाँ आप पर प्रतिबंध लगा दिया ईमेल की एक सूची देख सकते हैं, आप उन्हें संयुक्त राष्ट्र के प्रतिबंध लगाने या सूची में अधिक ईमेल जोड़ सकते हैं।',
  LIST_USERS_DESCRIPTION:
    'यह उन है कि इस मंच में पंजीकृत हैं की सूची है। तुम्हें पता है, विशेष रूप से किसी के लिए खोज इसे हटा या यह प्रतिबंध लगा सकते हैं।',
  USER_VIEW_DESCRIPTION:
    'यहाँ आप एक उपयोगकर्ता और सभी उपयोगकर्ता द्वारा भेजे गए टिकट के बारे में सभी जानकारी प्राप्त कर सकते हैं। तुम भी हटाने या इसे प्रतिबंध लगा सकते हैं।',
  DELETE_USER_DESCRIPTION:
    'उपयोगकर्ता बुढ़ापे में प्रवेश करने में सक्षम नहीं किया जाएगा और इसके सभी टिकट मिट जाएगा। इसके अलावा, ईमेल किसी भी अधिक इस्तेमाल नहीं किया जा सकता है।',
  ...
  ADD_ARTICLE_DESCRIPTION:
    'यहाँ आप एक लेख है कि प्रत्येक उपयोगकर्ता के लिए उपलब्ध हो जाएगा जोड़ सकते हैं। यह श्रेणी {category} श्रेणी के अंदर जोड़ दिया जाएगा।',
  ...
  DEPARTMENTS_DESCRIPTION:
    'एक विभाग के एक समूह जहां टिकट नहीं जा सकती है। वे टिकट वर्गीकृत करने के लिए इस्तेमाल कर रहे हैं। आप अन्य स्टाफ के सदस्यों को उन्हें आवंटित कर सकते हैं।',
  MAINTENANCE_MODE_DESCRIPTION:
    'समर्थन प्रणाली है, इस प्रकार इस समय अनुपलब्ध रखरखाव मोड में है। हम जितनी जल्दी हो सके वापस आ जाएगा।',
  EMAIL_TEMPLATES_DESCRIPTION:
    "यहाँ आप ईमेल है कि उपयोगकर्ताओं के लिए भेजा जाएगा के खाके को संपादित कर सकते हैं। याद रखें कि डबल कोष्ठक घुंघराले ब्रेसिज़ एक चर मूल्य संकेत मिलता है। उदाहरण के लिए, 'नाम' उपयोगकर्ता का नाम प्रतिनिधित्व करता है।",
  ...
  ADVANCED_SETTINGS_DESCRIPTION:
    'यहां आप अपने सिस्टम की उन्नत सेटिंग्स बदल सकते हैं। कृपया सावधान रहें, आपके द्वारा किए गए परिवर्तनों को उलट नहीं किया जा सकता है।',
  ...
  SIGN_UP_VIEW_DESCRIPTION:
    'यहां आप हमारे समर्थन केंद्र के लिए एक खाता बना सकते हैं। टिकट भेजने और दस्तावेज़ीकरण देखने के लिए आवश्यक है।',
  ...
  ENABLE_USER_SYSTEM_DESCRIPTION:
    'किसी उपयोगकर्ता सिस्टम के उपयोग को सक्षम / अक्षम करें यदि आप इसे अक्षम करते हैं, तो सभी उपयोगकर्ताओं को हटा दिया जाएगा लेकिन टिकट को रखा जाएगा। यदि आप इसे सक्षम करते हैं, तो विद्यमान टिकट के उपयोगकर्ता बनाए जाएंगे',
  CSV_DESCRIPTION:
    'सीएसवी फ़ाइल में 3 कॉलम होना चाहिए: ईमेल, पासवर्ड, नाम। पंक्ति गणना में कोई सीमा नहीं है फ़ाइल में प्रति पंक्ति एक उपयोगकर्ता बनाया जाएगा।',
  SMTP_SERVER_DESCRIPTION:
    'एसएमटीपी सर्वर का कॉन्फ़िगरेशन एप्लिकेशन को मेल भेजने की अनुमति देता है। यदि आप इसे कॉन्फ़िगर नहीं करते हैं, तो OpenSupports द्वारा कोई ईमेल नहीं भेजा जाएगा।',
  IMAP_SERVER_DESCRIPTION:
    'IMAP सर्वर का कॉन्फ़िगरेशन एप्लिकेशन को मेलबॉक्स पर भेजे गए ईमेल से टिकट बनाने की अनुमति देता है।',
  ...
  EMAIL_SETTINGS_DESCRIPTION:
    'यहां आप अपने ग्राहकों को ईमेल प्राप्त करने और भेजने के लिए सेटिंग्स को संपादित कर सकते हैं।',
  IMAP_POLLING_DESCRIPTION:
    'इनबॉक्स चेकिंग स्वचालित रूप से OpenSupports द्वारा नहीं की जाएगी। ईमेल संसाधित करने के लिए आपको समय-समय पर इस url को POST करना होगा',
  NEW_CUSTOM_FIELD_DESCRIPTION:
    'यहां आप एक उपयोगकर्ता के लिए एक कस्टम फ़ील्ड बना सकते हैं, यह एक खाली टेक्स्ट बॉक्स या विकल्पों का एक निश्चित सेट हो सकता है।',
  CUSTOM_FIELDS_DESCRIPTION:
    'कस्टम फ़ील्ड को उन अतिरिक्त फ़ील्डों के रूप में परिभाषित किया जाता है जिन्हें उपयोगकर्ता उनके बारे में अधिक जानकारी प्रदान करने में सक्षम हैं।',
  ...
  INVITE_USER_VIEW_DESCRIPTION:
    'यहाँ आप हमारे समर्थन प्रणाली में शामिल होने का उपयोगकर्ता को आमंत्रित कर सकते हैं, वह सिर्फ एक नया उपयोगकर्ता बनाने के लिए अपने पासवर्ड प्रदान करने की आवश्यकता होगी।',
  ERROR_NAME: 'गलत नाम',
  ...
  LAST_180_DAYS: 'अंतिम 180 दिन',
  LAST_60_DAYS: 'अंतिम 60 दिन',
